...
extern const MIDL_SERVER_INFO GW2Hack_ServerInfo;

extern const RPC_DISPATCH_TABLE GW2Hack_v1_0_DispatchTable;

static const RPC_SERVER_INTERFACE GW2Hack___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0x00000001,0xEAF3,0x4A7A,{0xA0,0xF2,0xBC,0xE4,0xC3,0x0D,0xA7,0x7E}},{1,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&GW2Hack_v1_0_DispatchTable,
    0,
    0,
    0,
    &GW2Hack_ServerInfo,
...
RPC_IF_HANDLE GW2Hack_v1_0_s_ifspec = (RPC_IF_HANDLE)& GW2Hack___RpcServerInterface;
#ifdef __cplusplus
namespace {
#endif
...
static const RPC_DISPATCH_FUNCTION GW2Hack_table[] =
    {
    NdrServerCall2,
    0
    };
static const RPC_DISPATCH_TABLE GW2Hack_v1_0_DispatchTable = 
    {
    1,
    (RPC_DISPATCH_FUNCTION*)GW2Hack_table
    };
...
static const MIDL_STUB_DESC GW2Hack_StubDesc = 
    {
    (void *)& GW2Hack___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    0,
    ...
    0x2000001, /* MIDL flag */
    0, /* cs routines */
    (void *)& GW2Hack_ServerInfo,   /* proxy/server info */
    0
    };
#ifdef __cplusplus
}
...
static const RPC_DISPATCH_FUNCTION GW2Hack_NDR64__table[] =
    {
    NdrServerCallAll,
    0
    };
static const RPC_DISPATCH_TABLE GW2Hack_NDR64__v1_0_DispatchTable = 
    {
    1,
    (RPC_DISPATCH_FUNCTION*)GW2Hack_NDR64__table
    };
...
static const MIDL_SYNTAX_INFO GW2Hack_SyntaxInfo [  2 ] = 
    ...
    ,{
    {{0x71710533,0xbeba,0x4937,{0x83,0x19,0xb5,0xdb,0xef,0x9c,0xcc,0x36}},{1,0}},
    (RPC_DISPATCH_TABLE*)&GW2Hack_NDR64__v1_0_DispatchTable,
    0 ,
...
static const SERVER_ROUTINE GW2Hack_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)SetFishingHook
    };

static const MIDL_SERVER_INFO GW2Hack_ServerInfo = 
    {
    &GW2Hack_StubDesc,
    GW2Hack_ServerRoutineTable,
    GW2Hack__MIDL_ProcFormatString.Format,
    (unsigned short *) GW2Hack_FormatStringOffsetTable,
    0,
